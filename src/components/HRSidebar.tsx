...
const getNavItems = (schoolId: string) => {
    return [
        { title: "Dashboard", href: `/hr/${schoolId}/dashboard`, icon: <LayoutDashboard className="h-5 w-5" /> },
        { title: "Staff Directory", href: `/hr/${schoolId}/directory`, icon: <BookUser className="h-5 w-5" /> },
        { title: "Staff Attendance", href: `/hr/${schoolId}/attendance`, icon: <ClipboardList className="h-5 w-5" /> },
        { title: "Salary Setup", href: `/hr/${schoolId}/salary`, icon: <Wallet className="h-5 w-5" /> },
        { title: "Payroll", href: `/hr/${schoolId}/payroll`, icon: <Briefcase className="h-5 w-5" /> },
    ];
};
...
export function HRSidebar({ schoolId, isCollapsed, toggleSidebar }: SidebarProps) {
  ...
  const dashboardLink = `/hr/${schoolId}/dashboard`;
