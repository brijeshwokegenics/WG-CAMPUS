...
const getNavItems = (schoolId: string) => {
    return [
        { title: "Dashboard", href: `/parent/${schoolId}/dashboard`, icon: <LayoutDashboard className="h-5 w-5" /> },
        { title: "Child's Profile", href: `/parent/${schoolId}/profile`, icon: <User className="h-5 w-5" /> },
        { title: "Attendance", href: `/parent/${schoolId}/attendance`, icon: <Calendar className="h-5 w-5" /> },
