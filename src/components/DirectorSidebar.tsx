...
const directorSidebarNavItems = (schoolId: string) => [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Fees", href: `/director/dashboard/${schoolId}/admin/fees`, icon: <Wallet className="h-4 w-4" /> },
  ...
  },
  {
    ...
    items: [
      { title: "Fees Management", href: `/director/dashboard/${schoolId}/accountant/fees`, icon: <Wallet className="h-4 w-4" /> },
