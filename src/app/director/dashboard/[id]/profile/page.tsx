...
export default function SchoolProfilePage({ params }: { params: { id: string } }) {
    ...
    if (loading) {
        return <div className="flex items-center justify-center h-full">Loading school data...</div>;
    }
    ...
    if (!school) {
        return <div className="flex items-center justify-center h-full">School not found.</div>;
    }
        ...
        <div className="w-full max-w-4xl mx-auto">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Update your school's information. Your School ID is {school.schoolId}.</CardDescription>
                </CardHeader>
                <CardContent>
