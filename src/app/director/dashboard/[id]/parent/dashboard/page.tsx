    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                 <Link href={`/director/dashboard/${schoolId}/parent/profile`}>
                 ...
                 <Link href={`/director/dashboard/${schoolId}/parent/attendance`}>
                    <Card className="hover:bg-muted/50 transition-colors">
                        <CardHeader className="flex flex-row items-center justify-between pb-2">
                 ...
                 <Link href={`/director/dashboard/${schoolId}/parent/fees`}>
                    <Card className="hover:bg-muted/50 transition-colors">
                        <CardHeader className="flex flex-row items-center justify-between pb-2">
                 ...
                 <Link href={`/director/dashboard/${schoolId}/parent/reports`}>
                    <Card className="hover:bg-muted/50 transition-colors">
                        <CardHeader className="flex flex-row items-center justify-between pb-2">
                 ...
                 <Link href={`/director/dashboard/${schoolId}/parent/elearning`}>
                    <Card className="hover:bg-muted/50 transition-colors">
                        <CardHeader className="flex flex-row items-center justify-between pb-2">
                 ...
                 <Link href={`/director/dashboard/${schoolId}/parent/calendar`}>
                    <Card className="hover:bg-muted/50 transition-colors">
                        <CardHeader className="flex flex-row items-center justify-between pb-2">
