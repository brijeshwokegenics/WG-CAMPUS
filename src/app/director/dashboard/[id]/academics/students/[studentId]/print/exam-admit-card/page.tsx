...
function ExamAdmitCardView({ schoolId, studentId }: { schoolId: string, studentId: string }) {
    ...
    return (
        <>
            ...
            <div className="admit-card-container bg-gray-100 flex items-center justify-center min-h-screen">
                <div className="admit-card p-6 rounded-lg w-[7in] h-[5in] bg-white flex flex-col">
